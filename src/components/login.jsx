                                        ...
                                        <div className="p-4 card">
                                            <div className="card-body">
                                                <form onSubmit={this.handleSubmit.bind(this)}>
                                                    ...
                                                    <p className="text-muted">Sign In to your account {context.UserContext.name} {context.UserContext.email} - {context.UserContext.isLoggedIn}</p>
                                        ...
                                        <div className="text-white bg-primary py-5 d-md-down-none card" >
                                            <div className="text-center card-body">
                                                <div show={this.state.show}>
                                                    ...
                                                    <button onClick={context.UserContext.login}>Atualiza</button>
